...
class _ScreenInterfaceState extends State<ScreenInterface> {
  ...
  // void _navigateSecondscreen() async {
  //   Navigator.push(
  //     context,
  //     MaterialPageRoute(
  //       builder: (context) => DetailsPage(dogList: dogList),
  //     ),
  //   );
  //   await refreshDogs();
  //
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(onPressed: () async{
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>DetailsPage(dogList: dogList)));
                await refreshDogs();
                  },
...
class DetailsPage extends StatelessWidget {
  ...
  List<Dog> dogList = [];
  DetailsPage({required this.dogList});
